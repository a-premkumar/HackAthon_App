...
<a href="#" id="callCenter" class="myButton" value="Call Center" onclick="tabChange(this)">Call centers</a>
<a href="#" id="offersPromotions" class="myButton" value="Offers/Promotions" onclick="tabChange(this)">Offers and Promotions</a>
